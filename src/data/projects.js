export const projects = [
  {
    id: 'p1',
    title: 'Gradify',
    desc: 'Gradify is an innovative web-based academic performance tracking system designed to streamline grade management for teachers and provide students with real-time feedback and insights.',
    image: '/assets/gradify.jpg',
    tech: ['ReactJs','Java','Spring Boot','PostgreSQL', 'GitHub Actions', 'Postman'],
    live: 'https://gradify-three.vercel.app/',
    repo: ''
  },
  {
    id: 'p2',
  ...
  },
  {
    ...
    image: '/assets/creativeclarity.jpg',
    tech: ['Springboot','ReactJs','Java','Postman', 'MySQL Workbench'],
    live: '',
